...
import { guardarEstEstudiante } from '../../../../api/estadosAPI';


AddEstEstudianteForm.propTypes = {
    reset: PropTypes.func,
    onClose: PropTypes.func
}

export default function AddEstEstudianteForm({ reset, onClose }) {
    const { auth } = useAuth();
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, actions) => {
            try {
                const response = await guardarEstEstudiante(values, auth?.token);
